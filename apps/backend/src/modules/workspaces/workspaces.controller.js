...
export const getWorkspace = asyncHandler(async (req, res) => {
  const workspace = await workspacesService.getWorkspace(req.params.workspaceId, req.user.id);
...
export const updateWorkspace = asyncHandler(async (req, res) => {
  ...
  const workspace = await workspacesService.updateWorkspace(req.params.workspaceId, data);
...
export const inviteMember = asyncHandler(async (req, res) => {
  ...
  const membership = await workspacesService.inviteMember(req.params.workspaceId, email, role);
...
export const removeMember = asyncHandler(async (req, res) => {
  await workspacesService.removeMember(req.params.workspaceId, req.params.userId);
