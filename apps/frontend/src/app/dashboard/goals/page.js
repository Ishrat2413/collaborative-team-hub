...
function GoalCard({ goal }) {
  ...
  return (
    <Link
      ...
      className='card-elevated block transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 group'>
  ...
  return (
    <div className='space-y-7 max-w-6xl'>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        ...
        <button
          className='btn-primary gap-2 w-full sm:w-auto justify-center sm:justify-start'
